...
class Pub
{
    ...
    {   
        if(request()->isPost()){
            ...
            if ($res) {
                return ajax_return_adv_error("已经存在该账号");
            }
            ...
            if ($register){
                return ajax_return_adv_error("恭喜您、注册成功！");
            }else{
                return ajax_return_adv_error("注册失败了哟、再试试吧！");
            }
    ...
    public function password()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $res = Db::name("AdminUser")->where("id", UID)->update(['password' => password_hash_tp($data['password'])]);
